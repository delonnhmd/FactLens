...
const styles = StyleSheet.create({
  ...
  label: { color: theme.colors.subtext, fontSize: 12, fontWeight: "500", marginBottom: 6 },
  input: {
  ...
  statusButtonText: { color: theme.colors.subtext, fontSize: 11, fontWeight: "500" },
  ...
  loadButtonText: { color: theme.colors.background, fontSize: 14, fontWeight: "500" },
  messageText: { color: theme.colors.danger, fontSize: 12, fontWeight: "500", marginTop: 8 },
  reportCard: {
    backgroundColor: theme.colors.background,
    borderColor: theme.colors.lightBorder,
    borderRadius: theme.radius.md,
  ...
  targetType: { color: theme.colors.ai, fontSize: 12, fontWeight: "500" },
  reportStatus: { color: theme.colors.subtext, fontSize: 11, fontWeight: "500" },
  reason: { color: theme.colors.text, fontSize: 16, fontWeight: "500", marginTop: 8 },
  ...
  hiddenText: { color: theme.colors.danger, fontSize: 12, fontWeight: "500", marginTop: 8 },
  ...
  resolveButtonText: { color: theme.colors.success, fontSize: 12, fontWeight: "500" },
  hideButton: {
  ...
  hideButtonText: { color: theme.colors.danger, fontSize: 12, fontWeight: "500" },
  restoreButton: {
  ...
  restoreButtonText: { color: theme.colors.sourceText, fontSize: 12, fontWeight: "500" },
