      ...
      >
        ...
        {!loading && isAuthenticated ? (
          <View style={styles.card}>
            ...
            {/* TASK 1 — Blocked users entry point (ALL users). Opens the existing
                app/settings/blocked-users.tsx screen. The identical row in
                Settings > Account is intentionally kept (harmless duplication)
                so no existing navigation breaks. */}
            <View style={styles.legalSection}>
